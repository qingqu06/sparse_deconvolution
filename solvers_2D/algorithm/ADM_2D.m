...
%
% 1. Fix A, and take a proximal gradient on {Xi}
% 2. Fix X, and take a Riemannian gradient on A
%
% Code written by Qing Qu
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

function [A, X, b, Psi_val, psi_val] = ADM_2D(Y, opts)
...
for iter = 1:opts.MaxIter
    ...
    Psi_X = psi_X + g_val( X, lambda, opts);
    
    % backtracking for update X and update stepsize t
    X_old = X;
    [X, t] = backtracking_2D( Y_b, A, X, psi_X, grad_psi_X, lambda, t, opts);
